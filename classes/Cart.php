    ...
    public function addToCart($userId, $productId, $quantity = 1) {
        try {
            ...
            if ($checkQuery->rowCount() > 0) {
                ...
                $updateQuery = $conn->prepare("UPDATE cart SET quantity = quantity + :quantity WHERE user_id = :user_id AND product_id = :product_id");
                ...
                $insertQuery = $conn->prepare("INSERT INTO cart (user_id, product_id, quantity) VALUES (:user_id, :product_id, :quantity)");
